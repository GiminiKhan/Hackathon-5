    ...
    return (
        <footer className="flex justify-center flex-col gap-8 w-full h-[555px] bg-white">
          ...
          <div className="flex flex-col gap-12 w-[286px] h-[101px]">
                    ...
                    <form>
                        <input type="text" className="border-b-2 border-b-neutral-950 w-[173px] h-[21px] text-sm" placeholder="Enter Your Email Address" />      <button type="submit" className="mx-4 text-black text-center border-b-2 border-black w-[70px] h-[20px] text-sm">SUBSCRIBE</button>
                    </form>
                </div>
            </div>
            <div className="border-t-2 p-8 text-black"><p>2022 Meubel House. All rights reverved</p></div>
